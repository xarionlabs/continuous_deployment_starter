...
def shopify_analytics_dag():
        ...
        try:
            ...
            metrics = {
                ...
                "customer_conversion_rate": (
                    round(customers_with_orders_count / total_customers_count * 100, 2)
            ...
            raise AirflowException(f"Customer metrics calculation failed: {str(e)}")
    ...
    def calculate_order_metrics(**context) -> dict:
        ...
        try:
            ...
            raise AirflowException(f"Order metrics calculation failed: {str(e)}")
    ...
    def calculate_product_metrics(**context) -> dict:
        ...
        try:
            ...
            logger.error(f"Failed to calculate product metrics: {str(e)}")
            from airflow.exceptions import AirflowException

            raise AirflowException(f"Product metrics calculation failed: {str(e)}")
